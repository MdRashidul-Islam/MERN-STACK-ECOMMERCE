...
export const ALL_HOME_PRODUCT_SUCCESS = "ALL_HOME_PRODUCT_SUCCESS";
export const ALL_HOME_PRODUCT_REQUEST = "ALL_HOME_PRODUCT_REQUEST";
export const ALL_HOME_PRODUCT_FAIL = "ALL_HOME_PRODUCT_FAIL";
